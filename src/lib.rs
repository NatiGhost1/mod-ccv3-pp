...
//! ```
//! // Decode the map
//! let map = modded_ccv3_pp::Beatmap::from_path("./resources/2785319.osu").unwrap();
//!
...
//! let diff_attrs = modded_ccv3_pp::Difficulty::new()
//!     .mods(8 + 16) // HDHR
...
//! let perf_attrs = modded_ccv3_pp::Performance::new(diff_attrs)
...
//!
//! ```
//! use modded_ccv3_pp::{Beatmap, GradualPerformance, Difficulty, any::ScoreState};
//!
